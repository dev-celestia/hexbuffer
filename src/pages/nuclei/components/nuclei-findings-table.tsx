...
interface NucleiFindingsTableProps {
...
export function NucleiFindingsTable({
  findings,
  selectedFindingId,
  onSelectFinding,
  searchQuery,
              ...
              {findings.map((finding) => {
                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <div className="flex items-center gap-1.5 font-mono text-[10px] text-muted-foreground">
                          ...
                          {finding.cve_id && (
                            <Badge
                              variant="outline"
                              className="h-3.5 px-1 text-[9px] font-bold text-amber-500 border-amber-500/30"
                            >
                              {finding.cve_id}
                            </Badge>
                          )}
                    ...
                    {/* Matched URL */}
                    <TableCell>
                      <span className="font-mono text-muted-foreground truncate max-w-md block select-all">
                        {finding.matched_url}
                      </span>
                    </TableCell>
                        ...
                        <div className="flex flex-wrap gap-1 max-w-xs">
                          {finding.extracted_results.map((res, i) => (
                            <Badge
                              key={i}
                              variant="secondary"
                              className="h-4 px-1.5 text-[10px] font-mono truncate max-w-[180px] bg-muted/60"
                            >
                              {res}
                            </Badge>
                          ))}
