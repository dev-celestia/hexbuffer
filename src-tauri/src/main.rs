...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            hexbuffer::commands::proxy::get_proxy_db_filter,
            hexbuffer::commands::proxy::set_proxy_db_filter,
            ...
            hexbuffer::commands::history::update_http_session_filter,
            hexbuffer::commands::history::clear_http_session_logs,
            ...
            hexbuffer::ai::abort_ai_chat_message,
            hexbuffer::ai::pause_ai_chat_message,
            hexbuffer::ai::resume_ai_chat_message,
            ...
            hexbuffer::commands::memory::set_memory_entry_pinned,
            hexbuffer::commands::memory::search_memory_hybrid,
            hexbuffer::commands::memory::run_memory_dream_cycle,
            hexbuffer::commands::memory::get_memory_edges,
            ...
            hexbuffer::commands::notes::delete_note,
            hexbuffer::commands::notes::delete_notes,
            ...
            // Regression testing (Nuclei YAML scripts)
            hexbuffer::commands::regression::list_regression_scripts,
            hexbuffer::commands::regression::save_regression_script,
            hexbuffer::commands::regression::delete_regression_script,
            hexbuffer::commands::regression::validate_regression_script,
            hexbuffer::commands::regression::run_regression_script,
            hexbuffer::commands::regression::abort_regression_run,
            hexbuffer::commands::regression::list_regression_script_runs,
            ...
            hexbuffer::commands::mock_forge::mock_server_start,
            hexbuffer::commands::mock_forge::mock_server_stop,
            hexbuffer::commands::mock_forge::mock_server_get_status,
            hexbuffer::commands::r2::r2_credentials_status,
            hexbuffer::commands::r2::save_r2_credentials,
            hexbuffer::commands::r2::clear_r2_credentials,
            hexbuffer::commands::r2::r2_list_buckets,
            hexbuffer::commands::r2::r2_list_objects,
            hexbuffer::commands::r2::r2_put_object_empty,
            hexbuffer::commands::r2::r2_delete_object,
            hexbuffer::commands::r2::r2_create_bucket,
            hexbuffer::commands::r2::r2_delete_bucket,
            hexbuffer::commands::r2::r2_upload_file,
            hexbuffer::commands::r2::r2_download_object,
            hexbuffer::commands::r2::r2_presign_url,
